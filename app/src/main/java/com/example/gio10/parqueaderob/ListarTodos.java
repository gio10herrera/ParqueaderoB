...
public class ListarTodos extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cur = GetAllData();
        llenar(cur);
        String from [] = new String[]{DaoVehiculo.VehiculoEntry.COLUMN_NAME_PLACA,DaoVehiculo.VehiculoEntry.COLUMN_NAME_HORAENTRADA,DaoVehiculo.VehiculoEntry.COLUMN_NAME_HORASALIDA,DaoVehiculo.VehiculoEntry.COLUMN_NAME_TOTALPAGAR};
