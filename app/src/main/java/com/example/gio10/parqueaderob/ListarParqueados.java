...
public class ListarParqueados extends AppCompatActivity {

    VehiculoDbHelper basedatos;
    ListView listarParqueados;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_listar_parqueados);

        listarParqueados = (ListView) findViewById(R.id.listarParqueados);
        cur = GetAllData();
        llenar(cur);
        ...
        try {
            ...
            Toast.makeText(ListarParqueados.this,e.getMessage(),Toast.LENGTH_LONG).show();
        }

        listarParqueados.setAdapter(adaptador);
        close();
    ...
    public Cursor GetAllData()
    {
        String sqlString = "SELECT * FROM " + DaoVehiculo.VehiculoEntry.TABLE_NAME + " WHERE " +
                DaoVehiculo.VehiculoEntry.COLUMN_NAME_ISOUT + "=0";
        abrir();
